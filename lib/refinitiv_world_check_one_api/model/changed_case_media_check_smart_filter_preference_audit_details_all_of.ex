...
defmodule RefinitivWorldCheckOneAPI.Model.ChangedCaseMediaCheckSmartFilterPreferenceAuditDetailsAllOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: RefinitivWorldCheckOneAPI.Model.ChangedCaseMediaCheckSmartFilterPreferenceAuditDetailsAllOf do
