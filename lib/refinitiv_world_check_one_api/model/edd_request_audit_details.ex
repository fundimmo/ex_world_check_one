...
defmodule RefinitivWorldCheckOneAPI.Model.EddRequestAuditDetails do
  @moduledoc """
...
defimpl Poison.Decoder, for: RefinitivWorldCheckOneAPI.Model.EddRequestAuditDetails do
