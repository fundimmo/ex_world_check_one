...
defmodule RefinitivWorldCheckOneAPI.Model.GenericCaseAuditDetails do
  @moduledoc """
...
defimpl Poison.Decoder, for: RefinitivWorldCheckOneAPI.Model.GenericCaseAuditDetails do
