...
defmodule RefinitivWorldCheckOneAPI.Model.CaseCreatedAuditDetails do
  @moduledoc """
...
defimpl Poison.Decoder, for: RefinitivWorldCheckOneAPI.Model.CaseCreatedAuditDetails do
