...
defmodule RefinitivWorldCheckOneAPI.Model.GenericCaseAuditDetailsAllOf do
  @moduledoc """
...
defimpl Poison.Decoder, for: RefinitivWorldCheckOneAPI.Model.GenericCaseAuditDetailsAllOf do
