...
defmodule RefinitivWorldCheckOneAPI.Connection do
  @moduledoc """
  Handle Tesla connections for RefinitivWorldCheckOneAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, RefinitivWorldCheckOneAPI.Connection,
        base_url: "https://api-worldcheck.refinitiv.com/v2",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :refinitiv_world_check_one_api,
        :base_url, "https://api-worldcheck.refinitiv.com/v2"
  """

  @default_base_url Application.compile_env(
                      :refinitiv_world_check_one_api,
                      :base_url,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:refinitiv_world_check_one_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - RefinitivWorldCheckOneAPI 2.53.0 - elixir"
        )
      )
